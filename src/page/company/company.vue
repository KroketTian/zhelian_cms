...
<script>
    ...
    let getTableDataService = getCompanyData,
        getDetailService = getCompanyDetail,
        addService = addCompany,
        editService = addCompany,
        deletService = deletCompany;
    let tableDataDemo = [
        {
            name:'id',
            tableTitleName:'id',
    ...
    export default {
        ...
        computed: {
            ...
            phoneList: {
                get: function(){
                    return this.addForm.telephones ? this.addForm.telephones.join(',') : '';
                },
                set: function(value){
                    this.addForm.telephones = value.split(',');
                }
            }
        },
        methods: {
