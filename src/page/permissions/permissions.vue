    ...
    <div class="autjorization">
        ...
        <div class="content-block">
            <el-table 
                ...
                border 
                default-expand-all
                :tree-props="{children: 'subPermissions', hasChildren: '!hasChildren'}"
                style="width: 100%">
                ...
                <el-table-column label="操作" width="250">
                    <template slot-scope="scope">
                        ...
                        <el-button type="primary" size="mini" @click="openAddTable(scope.row.id)">添加</el-button>
                    </template>
                </el-table-column>
            </el-table>
...
<script>
    ...
    let getTableDataService = getPermissionsData,
        getDetailService = getPermissionsDetail,
        addService = addPermissions,
        editService = addPermissions,
        deletService = deletPermissions;
    let tableDataDemo = [
        {
            name:'id',
            tableTitleName:'id',
