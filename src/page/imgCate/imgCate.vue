            ...
            <el-table :data="tableData" border style="width: 100%">
                ...
                <el-table-column label="操作" width="150">
                    <template slot-scope="scope">
                        <el-button type="primary" size="mini" @click="openDetailTable(scope.row.id,scope.row.name)">详情</el-button>
...
<script>
    ...
    let getTableDataService = getImgCateData,
        getDetailService = getImgCateDetail,
        addService = addImgCate,
        editService = addImgCate,
        deletService = deletImgCate;
    let tableDataDemo = [
        {
            name:'id',
            tableTitleName:'id',
