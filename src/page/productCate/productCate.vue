...
<script>
    ...
    let getTableDataService = getProductCateData,
        getDetailService = getProductCateDetail,
        addService = addProductCate,
        editService = addProductCate,
        deletService = deletProductCate;
    let tableDataDemo = [
        {
            name:'id',
            tableTitleName:'id',
